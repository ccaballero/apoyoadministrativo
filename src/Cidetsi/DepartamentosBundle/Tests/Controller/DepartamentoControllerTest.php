...
namespace Cidetsi\DepartamentosBundle\Tests\Controller;
...
public function testCompleteScenario()
{
    ...
    $form = $crawler->selectButton('Create')->form(array(
        'cidetsi_DepartamentosBundle_departamentotype[field_name]'  => 'Test',
    ...
    $form = $crawler->selectButton('Edit')->form(array(
        'cidetsi_DepartamentosBundle_departamentotype[field_name]'  => 'Foo',
        // ... other fields to fill
    ));
