...
class Materia
{
    ...
    public function addPrerequisito(\Cidetsi\DepartamentosBundle\Entity\Materia $prerequisitos) {
        $this->prerequisitos[] = $prerequisitos;
        return $this;
    }

    public function removePrerequisito(\Cidetsi\DepartamentosBundle\Entity\Materia $prerequisitos) {
